...
python main.py --benchmark "endless" --scenario "Classes" --algorithm "replay" --global_scheduler_mode "recl_sched" --eval_bs 16 --enable_double_buffer
python main.py --benchmark "endless" --scenario "Illumination" --algorithm "replay" --global_scheduler_mode "recl_sched" --eval_bs 16 --enable_double_buffer
python main.py --benchmark "endless" --scenario "Weather" --algorithm "replay" --global_scheduler_mode "recl_sched" --eval_bs 16 --enable_double_buffer
