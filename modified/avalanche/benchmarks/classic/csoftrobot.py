...
def load_soft_robot_dataset(dataset_root, scenario='ic'):
    if scenario == 'ic':
        dataset_root = os.path.join(dataset_root, 'soft_robot_ic')
    elif scenario == 'il':
        dataset_root = os.path.join(dataset_root, 'soft_robot_il')
    else:
        raise ValueError('Unknown scenario')
    train_dir = os.path.join(dataset_root, 'train')
    test_dir = os.path.join(dataset_root, 'test')
    train_set = ImageFolder(train_dir, transform=None)
    test_set = ImageFolder(test_dir, transform=None)
...
def SoftRobot(
    ...
    *,
    ...
    """
    train, test = load_soft_robot_dataset(dataset_root, scenario)
...
if __name__ == "__main__":
    ...
    benchmark_instance = SoftRobot(12, dataset_root="/experiment/.avalanche/data/soft_robot_data_raw/", scenario='ic')
    # benchmark_instance = SoftRobot(5, dataset_root="/experiment/.avalanche/data/soft_robot_data_raw/", scenario='il')
